...
namespace BlogWebApplication.BusinessManagers
{
    public class BlogBusinessManager : IBlogBusinessManager
    {
        ...
        public BlogBusinessManager(UserManager<ApplicationUser> userManager, IBlogService blogService, IAuthorizationService authorizationService, IWebHostEnvironment webHostEnviroment)
        {
        ...
        public async Task<ActionResult<EditViewModel>> UpdateBlog(EditViewModel editViewModel, ClaimsPrincipal claimsPrincipal){
            var blog = await _blogService.GetBlog(editViewModel.Blog.Id);
            ...
            if(editViewModel.BlogHeaderImage != null){
                string webRootPath = _webHostEnviroment.WebRootPath;
                string pathToImage = $@"{webRootPath}/UserFile/Blogs/{blog.Id}/HeaderImage.jpg";
        ...
        public async Task<ActionResult<EditViewModel>> GetEditViewModel(int? id, ClaimsPrincipal claimsPrincipal){
            ...
            return new EditViewModel{ Blog = blog };
        }
